...
<script>
    handleLogin = async () => {
        ...
        try {
            ...
            if (data.success) {
                window.location.href = '/esercizioSlim/frontend/homepage'; // Reindirizza alla dashboard
            ...
            console.log('Errore di connessione al server: ' + error.message);
        }
    };
    const sendButton = document.getElementById('send-form-button');
    sendButton.addEventListener('click', handleLogin);
</script>
</html>